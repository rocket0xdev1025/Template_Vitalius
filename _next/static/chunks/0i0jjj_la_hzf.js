    ...
    let r = (e = new Map(), r = null, o) => ({
      ...
      em = ((e, ...r) => {
                  ...
                  let { prefix: r, experimentalParseClassName: o } = e,
                    t = (e) => {
                      ...
                      return (
                        n.endsWith("!")
                          ? ((i = n.slice(0, -1)), (c = !0))
                          : n.startsWith("!") && ((i = n.slice(1)), (c = !0)),
                        b(o, c, i, r && r > s ? r - s : void 0)
                      );
                    };
                  if (r) {
                    let e = r + ":",
        ...
        let e = h("color"),
          ...
          G = () => [H, B, i],
          $ = () => [C, "full", "auto", ...G()],
          M = () => [W, "none", "subgrid", H, B],
          A = () => ["auto", { span: ["full", W, H, B] }, W, H, B],
          P = () => [W, "auto", H, B],
          er = () => ["auto", "min", "max", "fr", H, B],
          eo = () => [
            "start",
            "end",
            "center",
          ...
          ei = () => [e, H, B],
          ec = () => [...v(), V, E, { position: [H, B] }],
          ed = () => [
            "no-repeat",
            { repeat: ["", "x", "y", "space", "round"] },
          ],
          em = () => ["auto", "cover", "contain", X, q, { size: [H, B] }],
          ep = () => [I, J, K],
          eb = () => ["", "none", "full", c, H, B],
          eu = () => ["", O, J, K],
        ...
        return {
          ...
          classGroups: {
            aspect: [{ aspect: ["auto", "square", C, B, H, g] }],
            container: ["container"],
            "container-type": [{ "@container": ["", "normal", "size", H, B] }],
            "container-named": [L],
            columns: [{ columns: [O, B, H, n] }],
            ...
            grow: [{ grow: ["", O, H, B] }],
            shrink: [{ shrink: ["", O, H, B] }],
            order: [{ order: [W, "first", "last", "none", H, B] }],
            ...
            "auto-cols": [{ "auto-cols": er() }],
            "auto-rows": [{ "auto-rows": er() }],
            gap: [{ gap: G() }],
            "gap-x": [{ "gap-x": G() }],
            "gap-y": [{ "gap-y": G() }],
            ...
            "font-size": [{ text: ["base", o, J, K] }],
            "font-smoothing": ["antialiased", "subpixel-antialiased"],
            "font-style": ["italic", "not-italic"],
            "font-weight": [{ font: [t, ee, U] }],
            "font-stretch": [
              {
                "font-stretch": [
                  "ultra-condensed",
            ...
            "line-clamp": [{ "line-clamp": [O, "none", H, R] }],
            leading: [{ leading: [s, ...G()] }],
            ...
            "text-decoration-thickness": [
              { decoration: [O, "from-font", "auto", H, K] },
            ],
            "text-decoration-color": [{ decoration: ei() }],
            "underline-offset": [{ "underline-offset": [O, "auto", H, B] }],
            "text-transform": [
              "uppercase",
              "lowercase",
              "capitalize",
            ...
            "outline-offset": [{ "outline-offset": [O, H, B] }],
            "outline-w": [{ outline: ["", O, J, K] }],
            "outline-color": [{ outline: ei() }],
            shadow: [{ shadow: ["", "none", d, Z, F] }],
            "shadow-color": [{ shadow: ei() }],
            "inset-shadow": [{ "inset-shadow": ["none", m, Z, F] }],
            ...
            "text-shadow": [{ "text-shadow": ["none", p, Z, F] }],
            "text-shadow-color": [{ "text-shadow": ei() }],
            opacity: [{ opacity: [O, H, B] }],
            "mix-blend": [
            ...
            blur: [{ blur: ek() }],
            brightness: [{ brightness: [O, H, B] }],
            contrast: [{ contrast: [O, H, B] }],
            "drop-shadow": [{ "drop-shadow": ["", "none", b, Z, F] }],
            "drop-shadow-color": [{ "drop-shadow": ei() }],
            grayscale: [{ grayscale: ["", O, H, B] }],
            "hue-rotate": [{ "hue-rotate": [O, H, B] }],
            invert: [{ invert: ["", O, H, B] }],
            saturate: [{ saturate: [O, H, B] }],
            sepia: [{ sepia: ["", O, H, B] }],
            "backdrop-filter": [{ "backdrop-filter": ["", "none", H, B] }],
            "backdrop-blur": [{ "backdrop-blur": ek() }],
            "backdrop-brightness": [{ "backdrop-brightness": [O, H, B] }],
            "backdrop-contrast": [{ "backdrop-contrast": [O, H, B] }],
            "backdrop-grayscale": [{ "backdrop-grayscale": ["", O, H, B] }],
            "backdrop-hue-rotate": [{ "backdrop-hue-rotate": [O, H, B] }],
            "backdrop-invert": [{ "backdrop-invert": ["", O, H, B] }],
            "backdrop-opacity": [{ "backdrop-opacity": [O, H, B] }],
            "backdrop-saturate": [{ "backdrop-saturate": [O, H, B] }],
            "backdrop-sepia": [{ "backdrop-sepia": ["", O, H, B] }],
            ...
            duration: [{ duration: [O, "initial", H, B] }],
            ease: [{ ease: ["linear", "initial", k, H, B] }],
            delay: [{ delay: [O, H, B] }],
            animate: [{ animate: ["none", x, H, B] }],
